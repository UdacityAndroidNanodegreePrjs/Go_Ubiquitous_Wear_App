...
//for wear
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
           ...
           //wear :My Watch Face to display notification for High , Low temperature  and weather information on watch .
                if(i==0)
                {
                    wearHigh=high;
                    wearLow=low;
...
private void  notifyWearable(){//double high,double low,int wearWeatherId){
    PutDataMapRequest putDataMapRequest=PutDataMapRequest.create("/wear_face").setUrgent();
    putDataMapRequest.getDataMap().putString("HIGH_TEMP",""+Math.round(wearHigh));
    putDataMapRequest.getDataMap().putString("LOW_TEMP",""+Math.round(wearLow));
    putDataMapRequest.getDataMap().putInt("WEATHER_ID",wearWeatherId);

    putDataMapRequest.getDataMap().putLong("Time",System.currentTimeMillis());
    putDataMapRequest.getDataMap().putString("TT",String.valueOf(new Date().getTime()));
